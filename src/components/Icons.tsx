...
export const Icons = {
  ...
  FolderOpen: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" />
      <line x1="4" y1="21" x2="22" y2="21" strokeOpacity="0.5" />
    </svg>
  ),
  ...
  Bug: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 20.995c-1.886-1.886-2.995-4.47-2.995-7.198 0-2.728 1.109-5.312 2.995-7.198m0 14.396c1.886-1.886 2.995-4.47 2.995-7.198 0-2.728-1.109-5.312-2.995-7.198m0 14.396L12 21m0-14.396L12 3M3 12h18"/>
        <path d="M12 21a9 9 0 1 0-9-9"/>
        <path d="M3.28 4.72a9 9 0 0 0 0 12.56"/>
        <path d="M20.72 4.72a9 9 0 0 1 0 12.56"/>
    </svg>
  ),
